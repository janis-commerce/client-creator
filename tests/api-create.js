		...
		},
		{
			...
			before: sandbox => {
				...
				sandbox.stub(MicroserviceCall.prototype, 'safeList')
					.withArgs('id', 'client', { filters: { code: clients } }, {}, clients.length)
			...
			after: (res, sandbox) => {
				...
				sandbox.assert.calledOnceWithExactly(MicroserviceCall.prototype.safeList, 'id', 'client', { filters: { code: clients } }, {}, clients.length);
