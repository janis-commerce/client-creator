		...
		},
		{
			...
			before: sandbox => {
				...
				sandbox.stub(MicroserviceCall.prototype, 'safeList')
					.withArgs('id', 'client', { filters: { code: [validEvent.id] } }, {}, 1)
			...
			after: sandbox => {
				...
				sandbox.assert.calledOnceWithExactly(MicroserviceCall.prototype.safeList, 'id', 'client', { filters: { code: [validEvent.id] } }, {}, 1);
